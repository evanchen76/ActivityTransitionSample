...
class Scenery internal constructor(val sceneryId: Int, val name: String, val imageUrl: String, val thumbUrl: String, val desc: String) {
    companion object {
        ...
        fun getItem(id: Int): Scenery? {
            return scenerys.find { it.sceneryId == id }
        }
    }
}
